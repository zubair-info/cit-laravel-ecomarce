...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/fontend/assets/images/logo/favourite_icon_1.png') }}">

    <!-- fraimwork - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/bootstrap.min.css') }}">

    <!-- icon font - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/stroke-gap-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/icofont.css') }}">

    <!-- animation - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/animate.css') }}">

    <!-- carousel - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/slick-theme.css') }}">

    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/magnific-popup.css') }}">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/fontend/assets/css/jquery-ui.css') }}">
...
<body>
    ...
    <div class="body_wrap">
        ...
        ================================================== -->
        <header
            class="header_section {{ Route::CurrentRouteName() == 'homepage' ? ' header-style-no-collapse' : 'header-style-3' }}">
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="{{ asset('fontend/assets/images/flug/flug_uk.png') }}"
                                                alt="image_not_found">
                                        </div>
                                        <select>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="allcategories_collapse {{ Route::CurrentRouteName() == 'homepage' ? '' : 'collapse' }}"
                                    ...
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            ...
                                            @endphp
                                            @foreach ($categories as $category)
                                                <li><a href="shop_grid.html"><i
                                                            class="icon icon-Starship"></i>{{ $category->category_name }}</a>
                                                </li>
                                            @endforeach
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="{{ asset('fontend/assets/images/payments_icon.png') }}"
                                    alt="image_not_found">
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('/fontend/assets/js/jquery-plugins-collection.js') }}"></script>
